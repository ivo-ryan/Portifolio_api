import { AiController } from "./controllers/GeminiController";
...
import { TechsPrisma } from "./repositories/prisma/TechsPrisma";import { GeminiService } from "./services/geminiService";
;
...
export const geminiController = new AiController(geminiService);